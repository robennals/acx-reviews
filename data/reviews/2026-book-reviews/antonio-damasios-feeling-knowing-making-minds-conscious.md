---
title: 'Antonio Damasio’s Feeling & Knowing: Making Minds Conscious'
author: Unknown
...
Alter Ego: That’s unfair. Philosophy created the conceptual infrastructure for modern civilization, and the habits of mind underlying science, democracy, and pretty much every kind of innovation we take for granted. As [Keynes](https://www.goodreads.com/quotes/212215-practical-men-who-believe-themselves-to-be-quite-exempt-from) is often [paraphrased](https://www.facebook.com/groups/577099355725236/posts/25132105966464567/), "We all think the thoughts of dead philosophers."

That's fair. We owe philosophy a huge debt of gratitude. And yet… I agree with [Robert Pirsig](https://en.wikipedia.org/wiki/Robert_M._Pirsig) (best known for [Zen and the Art of Motorcycle Maintenance](https://en.wikipedia.org/wiki/Zen_and_the_Art_of_Motorcycle_Maintenance)) that most of what we call philosophy is really “[philosophology](https://andreaslloyd.dk/2008/01/philosophy-vs-philosophology/)” – like musicology versus music, it seems more interested in arguing about what people meant than actually creating useful meaning.
...
For Damasio, everything starts with [homeostasis](https://en.wikipedia.org/wiki/Homeostasis): an organism’s need to maintain equilibrium within its environment in order to survive. This core mechanic — an internal response to external circumstances — is the key to understanding everything that comes later.
...
Secondly, minded systems already have the ability to distinguish perceptions (our reactions to external stimuli) from [interoception](https://en.wikipedia.org/wiki/Interoception) (of internal stimuli). This is mediated by [proprioception](https://en.wikipedia.org/wiki/Proprioception), which is awareness of the rigid musculoskeletal structure that is the interface between our internal and external worlds.
...
For convenience, I extend the term "[affect](https://en.wikipedia.org/wiki/Affect_(psychology))" to cover all three.

### D. Knowing

In this view, "knowing" is just a higher-order feeling: the feeling that a specific sensation belongs to you. And that all animals with central nervous systems (certainly all vertebrates, and perhaps even many [arthropods](https://en.wikipedia.org/wiki/Arthropod)) are by this definition conscious.
...
> Together, the [insular cortex](https://en.wikipedia.org/wiki/Insular_cortex) and the subcortical components that feed into it constitute an "affect complex." The critical question, at this point, is how do these two sets of structures-the [posterior sensory cortices](https://en.wikipedia.org/wiki/Posterior_parietal_cortex) and the "affect complex"-combine to produce conscious minds? I envision two possibilities. One calls for actual neural projections from the "affect complex" to the "posterior sensory set" and vice versa. The other possibility calls for approximate simultaneity of activations in the two sets, resulting in the production of a time-based ensemble. In either option, the ultimate realization of a conscious mind depends on both sets of brain structures; we cannot "localize" consciousness to one or the other set. Moreover, one other sector of the cerebral cortices appears to play a role in coordinating the conscious mind processes. The sector is known as the... [Postero Medial Cortices](https://conservancy.umn.edu/items/da156ee8-15e9-47fc-8adb-ac098ff244fe)...It encompasses cortices largely located in medial (internal) and posterior surfaces of the cerebral hemispheres. This region may possibly direct the participation of other cerebral cortices in the making of a conscious mind.
...
But [was it conscious](https://www.organism.earth/library/document/what-is-it-like-to-be-a-thermostat)?
...
Beta: [raises eyebrows] You mean like [IEEE 754](https://en.wikipedia.org/wiki/IEEE_754) format?
...
Alter: [exclaiming] Ah! Then we have a non-trivial landscape of possible solutions. There's probably local minima -- like [Lagrange points](https://en.wikipedia.org/wiki/Lagrange_point) -- between each pair. But it is not a priori obvious which is the global minimum that, er, minimizes everyone's discontent.
...
Me: [Attention is all you need](https://en.wikipedia.org/wiki/Attention_Is_All_You_Need?wprov=sfti1#)!

[Me and Contra crack up while Alter and Beta stare at us blankly]

Contra: [wiping tears from his eyes] Sorry, sorry. That's the title of the paper on Transformer architectures, which led to all modern AIs. [sobering] I'm actually glad you brought that up. [Looking to Beta] Attention exists precisely to solve your non-convexity problem by identifying the right [feature circuits](https://transformer-circuits.pub/).
...
Alter: That sounds a lot like Karl Friston's [free energy principle](https://en.wikipedia.org/wiki/Free_energy_principle)!

Beta: Actually... that sounds like a [family](https://www.thebowencenter.org/introduction-eight-concepts).
...
By now -- as memorably [parodied by Scott Alexander](https://www.astralcodexten.com/p/turing-test) -- we are long past the point where people obsess over whether AI can pass the Turing Test. Even the Chinese Room experiment has lost its bite, since LLMs are much closer to human heuristics than rules-based symbol manipulation.
...
Anthropic has published [extraordinary research](https://www.anthropic.com/research/emotion-concepts-function) on this using what has been called "AI neurobiology". Not only did certain neurons end up tracking emotions detected from fictional stories, over-stimulating those neurons led to the AI preferentially acting out those emotions:
...
Alter: Let me try. Beta, the reason our thermostat coordinator needed to be conscious is that every office had its own valid thermostat setting. An efficient controller would simply ignore any user distress in order to maximize system efficiency. [looking at Contra] Like a [paperclip maximizer](https://aicorespot.io/the-paperclip-maximiser/).
...
Alter: Okay, for some reason this quote popped into my head: "[The Opposite of Addiction is not Sobriety, but Connection](https://www.psychologytoday.com/us/blog/love-and-sex-in-the-digital-age/201509/the-opposite-addiction-is-connection)"
