...
The Society Of The Spectacle is one long lament for this loss of The Real, although Debord doesn’t state it as such.  Borrowing again from The Uruk Machine, this sense of loss tracks with the gradual displacement of _metis_4 by _episteme_5.6
...
Debord spends a good chunk of words describing how the spectacle has affected art7 and physical space, but you can guess the gist by now.  Everything’s fake, everything’s worse, everything’s changing but also the same.
...
[Formatting note: Unfortunately, nobody could figure out a way to import linked footnotes from Google Docs into Substack.  I recommend opening a new tab and toggling back and forth - use CTRL + F and search for ### to jump down to the footnotes.]
