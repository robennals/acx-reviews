...
Nick Winter’s [The Motivation Hacker](https://www.google.com/url?q=https://www.nickwinter.net/the-motivation-hacker&sa=D&source=editors&ust=1770366146791299&usg=AOvVaw0-V2Q2IuaYayRwNRpPwB3D) is an exploration of how this misalignment arises, a highly practical review of techniques for correcting it, and a chronicle of his 3-month-long attempt to better approximate his utility-argmaxed self by running a startup, training for a marathon, increasing his subjective wellbeing from 6.3/10 to 7.3/10, and 15 other such ‘missions’ (including writing a book about it).
...
*   Expectancy is your subjective probability that you’ll achieve your goal if you try: you’re more motivated to do something if you think you can do it, and less if you don’t think you can.
*   Value is pretty self-explanatory - how much you value the goal being achieved.  
    Note that Expectancy and Value can be swapped out almost seamlessly for Expected Value - you don’t even need to change the symbols from EV. Expected Value is, of course, pretty much the same thing as Expectancy \* Value, but it allows different degrees of success - maybe if you want to write a book you have a 90% chance of at least getting your ideas down in a form others can read it, 40% of finishing a full book, 10% of getting it published, 0.1% of making the New York Times Bestseller’s list, etc. Proper Expected Value calculations take all these possibilities into account in a way that doesn’t transfer perfectly to multiplying two numbers. Still, considering the probability and value of success separately will be helpful later.
*   Impulsiveness is the amount of motivation you have to do other tasks. This variable isn’t actually a property of the task at hand, but of everything you’re currently considering. The obvious way this can stop you from doing what you value is to have something immediately rewarding right in front of you when you’re trying to concentrate on boring work, so that you’re more motivated to do that thing than your work. But this can happen even if you’re more motivated to do your work than to do any one other thing in particular (for example, trying to concentrate on an urgent email when you also have a tonne of undone chores you want to get done).
*   Delay is how far off the rewards for achieving the goal are (and how close the costs are). This term accounts for our brains’ internal hyperbolic discounting, or bias towards more immediate rewards. Again, a single number doesn’t capture all the nuances but it’s useful enough for now.  
    Hyperbolic discounting isn’t always irrational - it’s a necessary part of any Expected Value calculation, since almost any near-term reward enables you to seek larger rewards in the future (not to mention that life is short, hustling is overrated and the future is uncertain). But when it gets to the point where you’re trading watching TV now for everything else you know you should be doing instead, it becomes a major source of akrasia.

What I like about this model, oversimplified though it is, is that it’s pleasingly [pseudo-Bayesian](https://www.google.com/url?q=https://www.lesswrong.com/posts/MzKKi7niyEqkBPnyu/your-cheerful-price&sa=D&source=editors&ust=1770366146797361&usg=AOvVaw321AocYpCNIWpwEkqA3K-Y): you start with a prior distribution over all the actions you could be taking that’s defined by your utility function (Value), you update based on evidence for and against the hypothesis that putting in effort would actually gain you what you value (Expectancy), something something hyperbolic discounting to arrive at a final EV for each action (Delay), then compare relative posterior weights to evaluate hypotheses as to the best thing to do next (Impulsiveness). When this algorithm’s outputs fail to match the territory (as evaluated by your utility function), you act against your own best interests, and we call it akrasia (unless the error is produced by an incorrect Value estimation - more on that later). The automatic hyperbolic discounting step makes the whole process harder to update and means that it’s perfectly possible to be motivated to do something even when you know you shouldn’t, or vice versa.
...
Putting so much money at stake that you enthusiastically do something you want yourself to do is sort of reminiscent of the idea of a [cheerful price](https://www.google.com/url?q=https://www.lesswrong.com/posts/MzKKi7niyEqkBPnyu/your-cheerful-price&sa=D&source=editors&ust=1770366146806699&usg=AOvVaw3qXuO-dFsumMyuCqaJ7Ku5), the amount of money for which you can pay someone else to enthusiastically do something you want them to do. It’d be lovely if we all had someone to pay us a million dollars to go running every day, but if you don’t, the next best thing you can do is put a million dollars at stake (provided you have that much to lose).
...
*   If you had to pay a million dollars every day you didn’t go for a run, you wouldn’t waste any time having a mental argument over whether you should or shouldn’t go, and your decision wouldn’t be reluctant - you’d just get out the door and put one foot in front of the other until you were done. No matter how much your hyperbolic-discounting-brain wants to whine about it, going for a run isn’t that big of a deal. After a month or so of this, you’d have built up a habit, you’d get less and less tired, and you’d start to enjoy it. The enjoyment wouldn’t come from the commitment device but from the task itself - the commitment device is just there to get you out the door.
*   Upping your use of commitment devices doesn’t necessarily mean putting more at stake - you can also just commit to doing more things. Since motivation isn’t zero-sum and success begets success, each little thing you can get yourself to do pushes you on more and more of a virtuous cycle. (This definitely seems to match Winter’s self-reported experiences over the course of carrying out his missions.)

Winter specifically mentions [Beeminder](https://www.google.com/url?q=http://www.beeminder.com&sa=D&source=editors&ust=1770366146809618&usg=AOvVaw14X7QZeeoETadIfRV6O0Ta), a service offering about as good a commitment device as you can get: daily reporting with custom deadlines for eliminating delay, real-money stakes increasing every time you derail up to $7290 (the amount Winter stood to pay if he didn’t go skydiving or write enough words), which is close enough to a million dollars to motivate you to attempt almost anything.
...
*   Timeboxing: reduce Delay by forcing yourself to do something by a specific time (hint: use Beeminder)
*   Reminders: bring your goals to your attention so they’re always part of your (hint: use Beeminder)
*   Build habits: the more consistently you can do something, the easier it’ll get (just assume that Beeminder is useful for helping with all of these unless I say otherwise)
*   Break goals down into smaller parts to reduce Delay
*   Err on the side of using too many many motivational hacks
*   Choose goals that are meaningful to you, not ones you feel like you should do (okay Beeminder can’t help much with this)
...
1.  Write a book. (Tick.)
2.  Run a startup. (Kinda ill-defined, but he kept on top of his duties at [Skritter](https://www.google.com/url?q=http://skritter.com&sa=D&source=editors&ust=1770366146812741&usg=AOvVaw1NXooEpj4KZwzxYhHMa2Rc) making an app that helps people learn to write Chinese and Japanese. So tick.)
...
7.  Help to build [a cognitive testing website](https://www.google.com/url?q=http://www.quantified-mind.com/&sa=D&source=editors&ust=1770366146813562&usg=AOvVaw0N6FX4-xg67877Phq5drLI). (Help how? Too poorly defined to motivate him to do as much as he wanted.)
...
(You can read more about the specific missions [here](https://www.google.com/url?q=https://www.nickwinter.net/the-motivation-hacker/missions&sa=D&source=editors&ust=1770366146815134&usg=AOvVaw38KKlfNqAsIwpLP2Kmec9v).)
...
*   How socially anxious he used to be. The highlight is his experiments with rejection therapy, i.e. asking as many people in a random mall for random things he wanted, getting a fair amount of yeses, and discovering that being socially rejected really isn’t that bad. This is another occurrence of the theme of miscalibrated Value calculations, with a proposed solution of “try it and see how it is”.
*   How motivating working on a startup is. If you doubted how akratic Winter was before his big motivation experiment, here’s your vindication: he was working on something he highly valued and knew he could do with constant smaller subproblems and little else to occupy him. He doesn’t outright recommend leaving your job and staking your livelihood on whatever you want to commit to, but he doesn’t not recommend it.
*   A chapter about good and bad ways to pick goals (do what excites you or what gives you the best ROI, don’t just do what people expect, including what you expect if it’s not something you actually value any more). Lots of emphasis placed on the futility of motivation hacking if you’re pursuing the wrong goals.
*   A chapter on how important it is to measure your happiness in the moment (that happens to be the same chapter as the previous one about goal picking). I was struck by his example of going whitewater-rafting: his motivation for going was “Outdoor action adventure! This is going to be a lot of fun”, which is a good enough reason to do anything, I suppose. But his actual measurements reveal that between the long car rides and not getting enough to eat, his average happiness over the whole trip was 4.47/10. And yet, if he hadn’t measured it, he’d have remembered the brief periods of 8/10 excitement in the rapids and gone “that was awesome, we should go again sometime.” Another of his findings is that listening to music increases his happiness by 14% (!!), and spending two days curating his music library brought the effect up to 22% (!!!), increasing his happiness by 10% overall. Compared to the effect size of constant maxed-out motivation - that is, 0% - you have to wonder once more why anyone would attempt to take on 18 life-changing projects when they could find a cool new Spotify playlist instead.
