...
_Epistemic Status: A take on a book, its science, and the politics that make everything harder than it needs to be._
...
Koonin is one of the most qualified individuals in the world to talk about Climate Change.  I bring it up here because he brings it up in _Unsettled_.  Often and at great length.

He began his [career](https://en.wikipedia.org/wiki/Steven_E._Koonin#Biography) as a physicist but pivoted to climate science in 2004, first as BP’s chief scientist and later as undersecretary for science in Obama’s DoE (Department of Energy).

To restate that in more political terms, Koonin has, at one point or another, been an academic, worked for [Big Oil](https://en.wikipedia.org/wiki/Big_Oil), and worked for the public sector under Obama.
...
Koonin was asked by the [American Physical Society](https://www.aps.org/) to lead an update of their public stance on climate, and decided to actually attempt to figure out what a correct stance on climate might be:
...
I am impressed by this.  To me, this rings of Actual Science, in the sense of attempting to falsify one’s own hypothesis in rigorous fashion.  [Karl Popper](https://plato.stanford.edu/entries/popper/#BasiStatFalsConv) is clapping somewhere.  Specifically:

> …We posed some specific and crucial questions along the lines of: _Where is the data poor or the assumptions weakly supported - and does that matter?  How reliable are the models that we use to describe the past and project the future?_

You know, just some mild questions anyone might ask about a field that gets about [ten billion dollars of U.S. federal funding per year](https://www.gao.gov/products/gao-18-223).
...
When Koonin [went public](https://www.wsj.com/articles/climate-science-is-not-settled-1411143565) ([non-paywalled](http://www.sfu.ca/~palmer/Koonin.pdf)) with his findings, the general response was positive online, but Koonin’s anecdote about a response made in private is telling:
...
Koonin opens his discussion of scientific integrity with an appeal to the ultimate authority on all things scientific (and bongo drums): [Richard Feynman](https://en.wikipedia.org/wiki/Richard_Feynman), under whom Koonin studied at Caltech.

He quotes from Feynmane’s [Cargo Cult Science](https://calteches.library.caltech.edu/51/2/CargoCult.htm) speech:
...
He contrasts his own beliefs with that of [Stephen Schneider](https://en.wikipedia.org/wiki/Stephen_Schneider), another climate researcher ([source](https://stephenschneider.stanford.edu/Mediarology/mediarology.html#:~:text=Go%20to%20top-,The%20%22Double%20Ethical%20Bind%22%20Pitfall,the%20ifs%2C%20ands%20and%20buts.)) (emphasis mine):
...
In the wake of COVID-19, where [public health officials](https://www.lesswrong.com/posts/h4vWsBBjASgiQ2pn6/credibility-of-the-cdc-on-sars-cov-2) routinely lied to the public, this cuts very, very deeply.

Like Stan Lee, Koonin recognizes that with great power comes great responsibility:

> We’re the only people who can bring objective science to the discussion, and _that_ is our overriding ethical obligation.  Like judges, we’re obligated to put personal feelings aside as we do our job.  When we fail to do this, we usurp the public’s right to make informed choices and undermine their confidence in the entire scientific enterprise.
...
In other words (with apologies to [Shakespeare](https://www.poetryfoundation.org/poems/56965/speech-to-be-or-not-to-be-that-is-the-question)):
...
> …_**a location’s climate is the average of its weather over decades**__._
...
> …the rate of rise was twice as large as our 0.09℃/decade long-term average during the forty years from 1980 to 2020 (0.20℃/decade), while it was _negative_ during the forty years from 1940 to 1980 (-0.05℃/decade).
>
...
Anyone familiar with the [current issues in the social sciences](https://en.wikipedia.org/wiki/Replication_crisis) should be getting deja vu from this, or at least a sense of foreboding.  There is sufficient data to tell a wide variety of stories and a large incentive to tell some of them over others.  This doesn’t mean that Climate Science’s overall conclusions are wrong or untrue - but it should make us take a step back to make sure that the data isn’t cherry-picked.

Also confusing the issue is the difference between local and global effects.  CO2 concentration is similar throughout the atmosphere, so its effect should be more uniform across the planet; cities [tend to be warmer](https://www.sciencedirect.com/topics/earth-and-planetary-sciences/urban-heat-island-effect) than their surroundings due to a variety of effects.

Lastly, there are significant difficulties in estimating the temperature the further back we go in the past.  The first reliable thermometer wasn’t invented until [1714 by Daniel Fahrenheit](https://en.wikipedia.org/wiki/Thermometer#Era_of_precision_thermometry), and they didn’t become widespread until the mid-1800s.  Methods referenced by Koonin include weather diaries, crop yields, and [proxies](https://www.ncdc.noaa.gov/news/what-are-proxy-data) such as the thickness and composition of tree rings and temperature measurements of water in boreholes.
...
![](https://acximages.ennals.org/images/2022-book-reviews/c820a094a3271523.png)

_Koonin actually uses this picture from the wikipedia article on paleoclimatology in the book._
...
A (very basic) model of the Earth’s temperature goes like this: space is an insulator.  Since there’s no air in space [citation needed], [conduction](https://en.wikipedia.org/wiki/Thermal_conduction) and [convection](https://en.wikipedia.org/wiki/Convection_(heat_transfer)) are out, leaving [radiation](https://en.wikipedia.org/wiki/Thermal_radiation) as the only way that heat can enter or leave the planet as a whole.
...
Of course, [as the Earth gets hotter it radiates more heat outwards](https://en.wikipedia.org/wiki/Stefan%E2%80%93Boltzmann_law).  And the earth doesn’t perfectly absorb all the sunlight that hits it, either; some [gets reflected right back into space](https://en.wikipedia.org/wiki/Albedo#:~:text=Most%20land%20areas%20are%20in,of%20the%20contribution%20of%20clouds.).  But we can account for all that, and the math doesn’t lie.  As Koonin states:
...
Anyway, greenhouse gases keep the earth at a comfortable [average temperature of 57℉ (13.9℃)](https://www.space.com/17816-earth-temperature.html#:~:text=The%20average%20temperature%20on%20Earth%20lies%20somewhere%20around%2057%20degrees,and%20ocean%2C%20night%20and%20day.).  But what are the greenhouse gases, and which ones keep in the most heat?
...
This is the most basic assertion of Anthropogenic Climate Change I can think of.  It means that anyone attempting to paint Koonin as a “Climate Change Denier” is factually incorrect.  The evidence to the contrary is plain to see on page 51 of _Unsettled_.
...
The body is complex, however, and contains multiple feedback and feedforward loops and control systems, like the climate.  Perhaps eating more causes you to have more energy which leads to [fidgeting](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5117084/), which burns extra calories.  Perhaps eating at [different intervals](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6836017/) makes a difference.  Perhaps eating [different types of nutrients](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7480775/) changes how your body metabolizes your food.

Perhaps weight is set by a control system in your brain, and certain [contaminants](https://slimemoldtimemold.com/2021/07/07/a-chemical-hunger-part-i-mysteries/) can change how much your brain thinks your body ought to weigh.

### The One Percent

The Earth’s climate is far more complicated than an individual’s weight.  While human CO2 emissions have a warming effect on the climate, [aerosols](https://climate.nasa.gov/news/215/just-5-questions-aerosols/#:~:text=Using%20climate%20models%2C%20we%20estimate,(1.8%20%C2%B0F)%20hotter.) “such as those produced by the burning of low-quality coal” make the Earth reflect more solar radiation.  Deforestation also exerts a net cooling effect: “pasture is more reflective than forest.”
...
The Earth’s carbon undergoes a natural cycle.  Most of it is stuck in the planet’s crust ([1.9 billion billion tons](https://www.bbc.com/news/science-environment-49899039#:~:text=There%20are%201.85%20billion%2C%20billion,fluxes%22%20of%20the%20chemical%20element.)).  Next comes the oceans (40,000 billion tons), then the soil and living things (2,100 billion tons) and fossil fuels (5,000-10,000 billion tons), and finally the atmosphere (850 billion tons).
...
So we’ve got plenty of time, although before I read _Unsettled_ I’d never thought about CO2 concentrations getting to the point where the air isn’t actually _breathable._
...
![](https://acximages.ennals.org/images/2022-book-reviews/e92aa2ac9e4bba54.png)

![](https://acximages.ennals.org/images/2022-book-reviews/edd892ac2e7d216e.png)

Koonin notes that higher-emission scenarios are now taken to be much less likely as [new data emerges](https://iopscience.iop.org/article/10.1088/1748-9326/abcdd2).  However, because CO2 lasts in the atmosphere:

> A crucial point to take away from this discussion is that _human influences will continue to grow in any scenario short of ceasing all emissions._
...
But what about better simulations, with more data and blinky lights?  Can’t [Moore’s Law](https://en.wikipedia.org/wiki/Moore%27s_law) do for climate science what it’s done for [deep learning](https://www.gwern.net/Scaling-hypothesis)?

> More computer power cannot overcome this basic uncertainty.

Darn.  We’re in the realm of [chaos theory](https://en.wikipedia.org/wiki/Chaos_theory) now, and here there be [dinosaurs](https://www.youtube.com/watch?v=n-mpifTiPV4).

![](https://acximages.ennals.org/images/2022-book-reviews/d46a5e3d9a37fc0c.png)

_Obligatory XKCD._

That being said, all is not yet lost.  We don’t necessarily need precise details to understand the direction the climate as a whole will trend; remember that _climate_ is the average of weather over decades.  As Koonin writes,

> …while we can’t predict with much detail how individual bubbles will arise in a boiling pot of water, we _can_ confidently predict how the average level of the water will decline as a result of all that boiling.
...
While more orders of magnitude of compute _eventually_ solve this problem, we need to make decisions _now_, not in a few decades.
...
I was able to find [this paper](https://www.wcrp-climate.org/wgcm/references/IPCC_EM_MME_GoodPracticeGuidancePaper.pdf) which seems to suggest a greater level of sophistication when combining models than Koonin does, but since a) I haven’t read the IPCC report and he has and b) the paper is about recommendations, not specific results, I’m inclined to trust him.
...
> …the later generation of models is actually _more_ uncertain than the earlier one.  So here is a real surprise: even as the models became more sophisticated - including finer grids, fancier subgrid parametrizations, and so on - the uncertainty increased rather than decreased.
...
This discrepancy could possibly be explained by multi-decadal or multi-century cycles in the climate, such as the slow change of ocean currents and oceanic-atmospheric interactions, of which [El Niño](https://en.wikipedia.org/wiki/El_Ni%C3%B1o) is one of the most well-known.
...
> Observations extending back over a century indicate that most types of extreme weather events don’t show _any_ significant change - and some such events have actually become less common or severe - even as human influences on the climate grow.
...
Studies that attempt to determine the effect of anthropogenic climate change on extreme weather events are called “[event attribution studies](https://hal.inria.fr/hal-01872724/).”  As Koonin notes,
...
Here Koonin confidently asserts that the [2017 Climate Science Special Report](https://science2017.globalchange.gov/chapter/executive-summary/) (CSSR) is flat-out wrong.  From the report’s executive summary:
...
But the following year, you’ll have much fewer records - still some, but now you’re comparing each day’s temperature to the highest or lowest of a) the current year and b) _the entire previous year_.  So the number of record highs and lows will drop precipitously over time regardless of the general climate.  And when the number of record highs and lows get small enough, it’s easy for random variation to overwhelm any trend in the data.  The same gap of 10 between 50 record highs and 40 record lows produces an 11:1 ratio at 11 record highs and 1 record low!
...
Indeed, this error was caught in the [review of the report](https://science2017.globalchange.gov/PDFs/Review_Draft_CSSR_Final.pdf) (page 30) as Koonin notes, but both the ratio chart above and the finding of “increases of extreme warmth” remained in the final publication.
...
> _There have been some changes in temperature extremes across the contiguous United States.  The annual number of high temperature records set shows no significant trend over the past century nor over the past forty years, but the annual number of record cold nights has declined since 1895, somewhat more rapidly in the past thirty years._

I’ll add that milder temperatures are likely a net benefit for humanity, [although studying that is hard](https://astralcodexten.substack.com/p/chilling-effects?s=r).

#### Wildfires

While the section on wildfires is in the chapter on precipitation in the book, I preferred to group extreme weather by the [four elements](https://en.wikipedia.org/wiki/Classical_element), mostly because it seemed better, so we’ll briefly discuss wildfires here.  (Also I wanted to make [Earth, Wind, and Fire](https://en.wikipedia.org/wiki/Earth,_Wind_%26_Fire) jokes, but climate change has very little to do with earthquakes, so Earth is out and Water is in.)
...
While climate change absolutely plays a part here in making the forests drier, other human influences are equally, if not more, important.  Koonin cites forest management and human-caused ignition ([nearly 85% of fires](https://www.nps.gov/articles/wildfire-causes-and-evaluation.htm)) as among contributors to the increase in conflagrations.
...
Hurricane observations are sketchy pre 1944, when the first aircraft observations started, and become more reliable with the advent of satellite-based observations in 1966.  Before that we have to rely on “historical reports and various proxies,” leading to the awesome-sounding discipline of [paleotempestology](https://en.wikipedia.org/wiki/Paleotempestology).  (Cue [SYFY Channel](https://en.wikipedia.org/wiki/List_of_Sci_Fi_Pictures_original_films) original movie Dinostorm, successor to [Sharknado](https://en.wikipedia.org/wiki/Sharknado).)

So how has climate change affected hurricanes?

At first it seems that hurricanes have been getting worse.  From [NCA2014](https://nca2014.globalchange.gov/highlights/report-findings/extreme-weather):
...
From the [2017 CSSR](https://science2017.globalchange.gov/chapter/9/)’s Key Finding 1:
...
Also from the [same 2017 CSSR](https://science2017.globalchange.gov/chapter/9/) section:
...
Koonin points out that the [National Academies’ review of the CSSR](https://nap.nationalacademies.org/read/24712/chapter/5#37) “doubles down on burying the lede.”  Referring to Key Finding 1 above:
...
Koonin lambasts the way that scientists have communicated this data and the way the media portrays it.  He mentions [this landmark paper from 2019](https://journals.ametsoc.org/view/journals/bams/100/10/bams-d-18-0189.1.xml).  The abstract presents their strongest finding:
...
So human influences _may_ have altered the course of the hurricanes a little.  Not exactly a headline, but the above isn’t nearly as likely to generate a whole lot of clicks as forecasts of doom.

But haven’t there been [record damages](https://coast.noaa.gov/states/fast-facts/hurricane-costs.html#:~:text=2018%20and%202019%20each%20saw,combined%20total%20of%20%24136%20billion.) from hurricanes in recent years?

Koonin agrees, but counters that this has little to do with storms getting worse and much more to do with people building lots of valuable things on coasts.  In a [paper that attempts to normalize hurricane damage](https://www.nhc.noaa.gov/pdf/NormalizedHurricane2008.pdf) (i.e. by accounting for inflation and simulating what one hurricane would do if it hit in a different year), the authors affirm:
...
On the whole, storms don’t seem to have gotten measurably worse over the twentieth century, and human influence is difficult to understand at best.  While this doesn’t prove that humans are _not_ influencing extreme storms, it does show that no real signal has yet emerged from the noise.
...
I can already hear the cries about how climate change is causing [water injustice](https://astralcodexten.substack.com/p/justice-creep?s=r).
...
Globally, we don’t have compelling evidence either way on floods.  Koonin cites [AR5, Section 5.5](https://books.google.com/books?id=jn4mCAAAQBAJ&pg=PA425&lpg=PA425&dq=In+summary,+there+is+high+confidence+that+past+floods+larger+than+those+recorded+since+the+20th+century+have+occurred+during+the+past+500+years+in+northern+and+central+Europe,+western+Mediterranean+region,+and+eastern+Asia.&source=bl&ots=-WzPelsaAb&sig=ACfU3U3HtDbOe1VqwKYUILSHvkQHLDN2qg&hl=en&sa=X&ved=2ahUKEwjT6_HK0_32AhVDU98KHcenD6EQ6AF6BAgLEAM#v=onepage&q=In%20summary%2C%20there%20is%20high%20confidence%20that%20past%20floods%20larger%20than%20those%20recorded%20since%20the%2020th%20century%20have%20occurred%20during%20the%20past%20500%20years%20in%20northern%20and%20central%20Europe%2C%20western%20Mediterranean%20region%2C%20and%20eastern%20Asia.&f=false):

> In summary, there is _high confidence_ that past floods larger than those recorded since the 20th century have occurred during the past 500 years in northern and central Europe, western Mediterranean region, and eastern Asia.  There is, however, _medium confidence_ that in the Near East, India, central North America, modern large floods are comparable to or surpass historical floods in magnitude and/or frequency.
...
Contrary to [Roland Emmerich](https://en.wikipedia.org/wiki/Roland_Emmerich#Filmography) movies, Koonin contends that the future isn’t going to be a series of spectacular and cinematic disasters.  He begins with an attempt to determine how many people actually die from extreme weather events.

Using data from the [Center for Research on the Epidemiology of Disasters](https://www.emdat.be/) (CRED), we can see that weather-related deaths have decreased over the twentieth century, “largely due to better tracking of storms, better flood control, better medical care, and improved resilience as countries developed.”
...
He points out that the research paper itself is much more modest than the [headlines it generated](https://time.com/5876229/climate-change-death-rate/).  Koonin states that:
...
According to the [New York Times](https://www.nytimes.com/2019/08/08/climate/climate-change-food-supply.html), climate change is threatening the world’s food supply.  At this point, you should be expecting Koonin’s take, lifted straight from the [IPCC’s Special Report Key Finding A.1.4](https://www.ipcc.ch/srccl/chapter/summary-for-policymakers/):
...
Additionally, remember that CO2 is plant food - more CO2 in the atmosphere [actually](https://www.nasa.gov/feature/goddard/2016/nasa-study-rising-carbon-dioxide-levels-will-help-and-hurt-crops) _[increases](https://www.nasa.gov/feature/goddard/2016/nasa-study-rising-carbon-dioxide-levels-will-help-and-hurt-crops)_ [crop yields](https://www.nasa.gov/feature/goddard/2016/nasa-study-rising-carbon-dioxide-levels-will-help-and-hurt-crops), although the net effect of all human influences is undoubtedly more complicated.
...
You all know the drill by now.  The second volume of the Fourth National Climate Assessment (NCA2018) comes out, and the [media](https://www.nbcnews.com/news/us-news/federal-report-says-climate-change-will-wallop-u-s-economy-n939521) [lose](https://www.foxnews.com/politics/climate-report-warns-of-grim-economic-consequences-more-weather-disasters-in-us) [their](https://www.ft.com/content/216b5ed2-ef68-11e8-89c8-d36339d835c0) [minds](https://www.nytimes.com/2018/11/23/climate/us-climate-report.html).

That aside, what do we think the impact of climate change will be on the economy?

From the [report](https://nca2018.globalchange.gov/chapter/29/):
...
> Whatever its noble intentions, news is ultimately a business, one that in this digital era increasingly depends upon eyeballs in the form of clicks and shares.  Reporting on the scientific reality that there’s been hardly any long-term change in extreme weather doesn’t fit the ethos of _If it bleeds it leads._  On the other hand, there is always an extreme weather story somewhere in the world to support a sensational headline.

I’m inclined to agree with him here.  I’d like to add that, rather than blaming any individual or political camp, I put the media’s lack of ability to report honestly on climate change on the incentives of the industry.  Our society finds itself more and more in a war for attention, and [outrage](https://slatestarcodex.com/2014/12/17/the-toxoplasma-of-rage/) gathers more attention than analysis.  Additionally, those with the training to truly understand the science usually have better things to do than report on it.
...
> Politicians on the right who deny even the basics that science _has_ settled - that human influences have played a role in warming the globe - are not above exploiting climate science uncertainties, offering them as “proof” that the climate isn’t changing after all.
>
...
Koonin gives an example of the presidents of a scientific institution, the National Academies of Science, Engineering, and Medicine, issuing the [following statement](https://www.nationalacademies.org/news/2019/06/national-academies-presidents-affirm-the-scientific-evidence-of-climate-change):
...
Koonin’s main suggestion to improve the state of climate science is to include [red team exercises](https://en.wikipedia.org/wiki/Red_team) for assessment reports.  Common in military and cybersecurity settings, red team exercises involve designating a group of people specifically to “attack” the weak points of something (in this case, the assessments).  The results can then be shared with the original authors and incorporated to create more robust documents.

Koonin received backlash to this idea when he suggested it, with the main argument being that said work had already been peer-reviewed.  His response is that while the _research_ has been peer reviewed, the assessment reports themselves are not research papers and have different, less objective review standards:
...
_Unsettled_ is an attempt to push back against the alarmism Koonin sees.  It emphasizes error bars, uncertainty, and transparency over persuasion and hyperbole.
