...
Given that this was written _before_ the Russian Revolution and the whole bloody mess of the 20th century, this is an impressive insight, and it is perhaps because of quotes like this that some call _The Brothers Karamazov_ prophetic.
...
One may wonder though, if this is true, then how is it that there seems to be a substantial number of religious people with smug, holier-than-thou attitudes? How can one square that with humility? C.S. Lewis addresses this question directly in _Mere Christianity_:
