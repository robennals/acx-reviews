---
title: The Delusion of Infinite Economic Growth
author: Unknown
...
In the article, as part of the aforementioned fluff, they briefly touch on recycling, and point out that it too has limits. This is true, but we mustn't leave ourselves with such a qualitative statement. What’s the theoretical maximum ability to recycle? A naive answer would be that E=mc^2, mass-energy cannot be created or destroyed, and so at the limit they are infinitely recyclable. But there’s actually an easy upper bound to this question.

There’s one thing we know is irreversible, which I hinted to with my assumptions above – entropy always increases. The second law of thermodynamics. Order goes to disorder, and a cloud of hydrogen eventually turns into a black hole. Which turns into Hawking radiation. But we can well approximate the maximum entropy of a system with a black hole, which is convenient for our purposes.
