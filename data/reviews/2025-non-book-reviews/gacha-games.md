...
This is not a review that’s intended to get you to play the game. Some of them are good games, yes, but these things have hooks in them. And – well, you may have noticed, but there are a lot of good video games out there these days. It’s hard to justify engaging with a game with a gacha hook when you could be playing something else instead. Instead, this review is intended to tell you about this mechanic, and share a few funny stories about individual games within the genre.
...
So now we can say: a gacha game is designed to keep you interested in the “game” part for long enough that you decide to spend money to get good characters.
...
It’s hard to be specific about the actual plot, because it varies so much between games. You might be building a base, or searching for something you lost, or gathering forces to defeat a powerful foe, or maybe just trying to survive.

But whatever you’re doing, you’re never going to finish it. Gacha games are like visual novels released one chapter at a time. They can’t ever end, because if they ended, everyone would stop playing, and thus stop giving them money.

The story could be beautiful and dramatic and lush, or it could be grimdark, or it could be people talking at each other for minutes while you wish there was a fast-forward button. Hopefully it’s good, because the story is what you're playing the game to experience.

The story is single-player, and it is fully linear. The story is always fully linear, because the story is expensive to produce, and the developers aren't going to split their story budget two ways to handle both branches of a key decision. You'll make the same choices everyone else makes. Often, they'll be good choices that you would have made anyway. Sometimes they'll be sort of frustrating. [3]

The story will be time-gated, in the sense that certain chapters won’t unlock until you’ve played for a certain number of days. (Technically the mechanic they use is that you need a certain amount of “account experience”, but account experience mostly comes from daily activities, so the effect is time gating.)

The story will also be time-gated, in the sense that only a certain amount of story is published. Eventually you’ll hit the end, and the game will say “continued next update,” and you’ll have to wait a few weeks before you can see what happens next. Most of the players of a gacha are in this state most of the time.

Finally the story will be progression-gated, in the sense that you’ll have obstacles to overcome, and you’ll need your characters to be powerful enough to do that. But the character-power requirement is often low. If users get locked out of content because they can’t handle the difficulty, they’ll quit the game, and the developers want to avoid that.

Still, you’ll want to level your characters.

## 2.2. Leveling Your Characters.

If you're coming from an RPG background, you probably think of leveling your characters as something that just happens. Kill a goblin, gain a level. Kill the same goblin a hundred times because he respawns whenever you leave the zone and come back, gain ten more levels. Maybe leveling gives you some stat points to distribute or skill choices to make. That's how levels work in an RPG.

Gacha games work differently. Leveling your characters is a huge chunk of the game, and it's approached with an appropriate amount of seriousness.

You do get experience for killing goblins, but it's a pittance – rounds to zero. If you want to gain real experience, you have to find some experience scrolls and feed them to a character using the "level up your characters" interface. If you run out of experience scrolls, there's a special zone you can go fight in where the monsters drop experience scrolls. It costs stamina to fight in this special zone; stamina replenishes slowly over time.

(These things aren’t called “experience scrolls” and “stamina”, but they appear in every game. Once you’ve played one gacha, all the others will be easier to understand, because you’ll see an item named “Wanderer’s Advice” or “Resonance Potion” or “Combat Report” and you’ll say, oh, that’s what they call experience scrolls here.)

Periodically your characters will hit a level cap. There's a cost to unlock the level cap so that you can level them some more; the cost is paid in other kinds of in-game currency. These currencies will come from a special zone you can fight in. It costs stamina.

In addition to levels, your characters have skills, which are sort of a multiplier on how much damage they do. Upgrading skills requires another kind of in-game currency, which also comes from a special zone which costs stamina.

Upgrading anything will cost gold, which is another kind of in-game currency. Gold comes from a different special zone, which also costs stamina.
...
If you decide you want the character, you can keep doing pulls until you get them. The game gives you an allowance of in-game currency which you can use for pulls; if you run out, you can pay real money for more pulls.

If you don’t want the character, there will be a new banner in a few weeks. Sometimes the game will offer you a rerun of a previous banner, in case you missed a character the first time around. But the game tries to offer you new first-time-offered characters on a regular basis, because that’s how it makes money.

## 2.4. Story Characters and Gacha Characters.
...
### 3.1. Okay, let's talk about the cost.

How much could it cost to play a gacha game? The cost is zero, or more than you think, but less than infinity.
...
(This is usually true, but your mileage will probably vary depending on the game.)

### 3.2. What about the time cost?
...
We should talk about a horrible thing called “reroll accounts”.

The idea is: when you first start playing a gacha, it will give you a single top-tier character for free, as a starter. Some of the characters in this pool are much better than other characters.

If you start playing, and you don’t like the character you get… one option is to uninstall the whole game, create a new account, and start over.

The developers know that you can do this, and they have a variety of responses. One approach is to make you play through a long chunk of introduction and exposition before you find out what character you’re getting. (In fairness, this makes sense even if they’re not trying to interfere with someone’s reroll strategy.) This is likely to make you less interested in rerolling.
...
I’m not aware of any gacha games that have any nudity or sex in them.

## 4\. The Actual Review.

Claude reviewed some early drafts of this review, and the feedback it kept giving me was that I should conclude with a clear yes-or-no verdict on whether gacha games are any good.
