...
r!Animorphs often has interludes between arcs, but they largely feature villains or "NPCs"[15] reacting to something that just happened. This keeps the main plot in stasis until the next character focused update.
...
Finally, let’s take a broader look at the expansion of Animorphs canon. Methods of Rationality was far more about Harry badly applying rationality to problems and overcoming them than it was about Harry researching or inventing types of magic. This is usually the biggest complaint people have with the fic, maybe tying with "I want to punch this kid". While HPMOR did get quite a few recursive fanfics,[18] they're often just sequels or building on the existing plot. Critically, there are few if any AU fics that simply "steal" things from the setting, because it didn’t add much that wasn’t critical to the story’s twists and turns.
...
You can implement most of these without significantly altering the direction of your story, so I expect this fic is or will be pretty fandom-influential, for the ten people still writing Animorphs fics.[19] Garrett as a whole is pretty good too (yes, despite some questionable writing decisions), a good emotional core for the story with Cassie gone. There are probably some situations where he could be reused.
...
[4] There’s some intentional mirroring between morphing and yeerk bodyjacking in canon, but r!Animorphs doesn’t nearly focus as much on Themes.

[5] There are a lot of seemingly moral arguments in r!Animorphs, but they usually take the form of Utilitarianism vs Less Extreme Utilitarianism.
...
[18] A recursive fanfic is a fanfic of a fanfic. I don’t think I ever heard this term before the “final exam” arc and the end of HPMOR triggered an avalanche of them.

[19] While looking for fandom stuff, I saw a new reader being told to just use the r!Animorphs last names as a headcanon, so this isn't just hypothetical.
