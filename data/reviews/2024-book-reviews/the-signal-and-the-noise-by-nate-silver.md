...
I suspect Silver’s background informs his world view. Nate Silver used to be a successful[[4]](#ftnt4) poker player. He used his statistical prowess to become a successful baseball statistician. He then used that same mind to create a successful business making political predictions. What do all these things have in common – in the world of statistics? They’re all games of chance, sure. But they’re all a particular kind of game:
...
Scott’s [recent review](https://www.astralcodexten.com/p/practically-a-book-review-rootclaim) of the lab leak/zoonosis debate revealed a bizarre result when Bayesian principles were taken to their logical conclusion. Instead of Bayesian math converging on a single answer … well everyone kind of went their own way.[[9]](#ftnt9) What went wrong in the Rootclaim debate? Scott gives some insight that should cause any Bayesian serious reflection (emphasis mine):
...
But they[[10]](#ftnt10) also have some bad habits of estimating prior probabilities post hoc or in other invalid ways. They do a quick and dirty ‘Bayesian’ estimate, or sometimes even formally plug the numbers into a spreadsheet, and they get a false sense of precision. They lean a little too hard on the training wheels.
...
*   Don’t overfit[[11]](#ftnt11) based on past cases.
*   Low-probability events sometimes[[12]](#ftnt12) happen.
...
*   Don’t overlearn from computer[[13]](#ftnt13) model outputs.
...
[[8]](#ftnt_ref8) I’m not claiming Bayesian principles are never applicable. But Silver’s dismissiveness about Fisher and all principles of frequentist statistics makes it clear that he thinks everything but a Bayesian approach should be abandoned. Consider which of these two positions makes more sense:
