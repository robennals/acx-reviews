...
In a way, Berne and Harris's endeavors can be contrasted to Lacan's, their contemporary. Both had little success and some contempt for traditional approaches, yet base themselves directly on Freud. Both Transactional Analysis and Lacanian Analysis seem to have a particular interest in mathematics and meta-approaches. But while Lacan concerns himself with the entirety of Psychoanalysis and expresses himself in an obscure and complicated way, Berne and co. takes the opposite approach. Transactional analysis disregards Freudian concepts of the unconscious, focusing only on what is tangible, clearly defined, and easily expressed. This is done by a focus on the concept of _ego states_, which are subparts of the Freudian ego.
